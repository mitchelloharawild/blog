...
allowing you to choose between `casual` (default), `classic`, `oldstyle`, 
...
Thanks to contributions from [\@chrisumphlett](https://github.com/chrisumphlett), and [\@jonmcalder](https://github.com/jonmcalder) for this release.