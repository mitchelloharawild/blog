...
As of today, the vitae package is now available on [CRAN](https://cran.r-project.org/package=vitae). Is it time to update your CV? Get started with the package by reading the [*introduction to vitae*](https://ropenscilabs.github.io/vitae/articles/vitae.html). Also, look out for a blog post tomorrow on the [rOpenSci blog](https://ropensci.org/blog/) about the design decisions around vitae, and some examples of how it can be used to quickly create your next CV.
